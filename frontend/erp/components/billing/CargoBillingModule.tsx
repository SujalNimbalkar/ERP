...
import { exportCargoBillExcel } from "@/components/billing/billExcel";
...
export function CargoBillingModule() {
    ...
    return (
      <div className="max-w-5xl">
        <div className="mb-4 flex flex-wrap items-center gap-3 print:hidden">
          ...
          <button
            type="button"
            onClick={() => exportCargoBillExcel(viewBill)}
            className="rounded-md border border-black/15 bg-white px-4 py-2 text-sm font-medium text-black transition-colors hover:bg-black/5"
          >
            Save as Excel
          </button>
  ...
  return (
    <div className="max-w-5xl">
      <div className="mb-6 print:hidden">
        <h2 className="text-xl font-semibold text-black">Cargo Transport Billing</h2>
      ...
      <div className="space-y-5 print:hidden">
        ...
        <div className="flex flex-wrap items-center gap-3">
          ...
          <button
            type="button"
            onClick={() => exportCargoBillExcel(draft)}
            className="rounded-md border border-black/15 bg-white px-5 py-2.5 text-sm font-medium text-black transition-colors hover:bg-black/5"
          >
            Save as Excel
          </button>
